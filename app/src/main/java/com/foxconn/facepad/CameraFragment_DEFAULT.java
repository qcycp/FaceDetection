 ...
 */
public class CameraFragment_DEFAULT extends Fragment {
    /**
     * Tag for the {@link Log}.
     */
    private static final String TAG = CameraFragment_DEFAULT.class.getCanonicalName();
    ...
    private final TextureView.SurfaceTextureListener mSurfaceTextureListener
        ...
        public void onSurfaceTextureUpdated(SurfaceTexture texture) {
            if (!mIsDetecting) {
                ...
                new detectAsync_haar_default().execute(bp);
            }
        }
    };
    ...
    public static CameraFragment_DEFAULT newInstance() {
        return new CameraFragment_DEFAULT();
    }
    ...
    /**
     * Opens the camera specified by {@link CameraFragment_DEFAULT#mCameraId}.
     */
    ...
    private class detectAsync_haar_default extends AsyncTask<Bitmap, Void, MatOfRect> {
        @Override
