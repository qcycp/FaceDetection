 ...
 */
public class CameraFragment_DNN extends Fragment {
    /**
     * Tag for the {@link Log}.
     */
    private static final String TAG = CameraFragment_DNN.class.getCanonicalName();
    ...
    private final TextureView.SurfaceTextureListener mSurfaceTextureListener
        ...
        public void onSurfaceTextureUpdated(SurfaceTexture texture) {
            if (!mIsDetecting) {
                ...
                new detectAsync_dnn().execute(bp);
            }
        }
    };
    ...
    public static CameraFragment_DNN newInstance() {
        return new CameraFragment_DNN();
    }
    ...
    /**
     * Opens the camera specified by {@link CameraFragment_DNN#mCameraId}.
     */
    ...
    private class detectAsync_dnn extends AsyncTask<Bitmap, Void, Mat> {
        ...
        protected Mat doInBackground(Bitmap... bp) {
            ...
            Mat blob = Dnn.blobFromImage(dst, IN_SCALE_FACTOR,
                    ...
                    new Scalar(MEAN_R, MEAN_G, MEAN_B), /*swapRB*/false, /*crop*/false);
            net.setInput(blob);
            ...
            Log.d(TAG, "cols: " + cols);
            Log.d(TAG, "rows: " + rows);
            detections = detections.reshape(1, (int)detections.total() / 14);
