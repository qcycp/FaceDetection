 ...
 */
public class CameraFragment_ALT extends Fragment {
    /**
     * Tag for the {@link Log}.
     */
    private static final String TAG = CameraFragment_ALT.class.getCanonicalName();
    ...
    private final TextureView.SurfaceTextureListener mSurfaceTextureListener
        ...
        public void onSurfaceTextureUpdated(SurfaceTexture texture) {
            if (!mIsDetecting) {
                ...
                new detectAsync_haar_alt().execute(bp);
            }
        }
    };
    ...
    private BoundingBoxView_DNN mBoundingBoxView_DNN;
    ...
    public static CameraFragment_ALT newInstance() {
        return new CameraFragment_ALT();
    }
    ...
    /**
     * Opens the camera specified by {@link CameraFragment_ALT#mCameraId}.
     */
    ...
    private class detectAsync_haar_alt extends AsyncTask<Bitmap, Void, MatOfRect> {
        ...
        protected MatOfRect doInBackground(Bitmap... bp) {
            ...
            Mat temp = new Mat();
            Mat dst = new Mat();
            Utils.bitmapToMat(bp[0], src);
            Imgproc.cvtColor(src, temp, Imgproc.COLOR_BGRA2BGR);
            Imgproc.cvtColor(temp, dst, Imgproc.COLOR_BGR2GRAY);

            File mFaceCascadeFile = new File("/data/user/0/com.foxconn.liveness/app_cascade/haarcascade_frontalface_alt.xml");
            ...
            mJavaDetector.detectMultiScale(dst, faces, 1.15, 5, 2, // TODO: objdetect.CV_HAAR_SCALE_IMAGE
                    new org.opencv.core.Size(35, 35), new org.opencv.core.Size());
